...
function displayJSONinHTML()
{
  ...
  try
  {
        ...
        htmlElems += `
          <div class="row" style="margin-top:5px; background-color: ${ backColor };">
            <div class="col-xs-10">
              <div class="row">
                <div class="row">
                  <div class="col-xs-4"><em>${ vin.CEPAGE }</em></div>
                  <div class="col-xs-4"><em>${ vin.NOM }</em></div>
                  <div class="col-xs-4">${ vin.CEPAGE_2 }</div>
                </div>
              </div>
              <div class="row">
                <div class="row">
                  <div class="col-xs-4">${ vin.REGION }</div>
                  <div class="col-xs-2">${ vin.ANNEE }</div>
                  <div class="col-xs-2">${ vin.COULEUR }</div>
                  <div class="col-xs-4">${ vin.PRIX } CHF</div>
                </div>
                <div class="row">
                  <div class="col-xs-12"><small class="text-muted">${ aoc } ${ vin.INFORMATIONS_COMPLEMENTAIRES }&nbsp;</small></div>
                </div>
              </div>
            </div>
    ...
    htmlElems +=`
    <div class="row">
      <div class="col-xs-10 text-right">total des bouteilles commandées (CHF)</div>
      <div class="col-xs-2 text-center"><p style="padding-right:30px;" id="total1" class="text-right">0.00</p></div>
    </div>
    <div class="row">
      <div class="col-xs-10 text-right">frais d’emballage et de livraison (CHF)</div>
      <div class="col-xs-2 text-right"><p style="padding-right:30px;">${ fraisDePort.toFixed( 2 ) }</p></div>
    </div>
    <div class="row">
      <div class="col-xs-10 text-right"><strong>total avec TVA 8% incluse (CHF)</strong></div>
      <div class="col-xs-2 text-right"><p style="padding-right:30px;" id="total2"><strong>0.00</strong></p></div>
    </div>
    ...
    <div class="row" style="margin-top:30px;">
      ...
      <div class="row" style="margin-top:5px;">
        ...
        <div class="col-sm-8 col-xs-12" style="margin: 0px;"><input name="adresse-livraison-mail" type="email" class="" /></div>
      </div>
    </div>
    ...
    <div class="row" style="margin-top:30px;">
      <div class="row" style="margin:15px 0;">
        ...
        <div class="col-xs-12" style="margin: 12px 0 4px"><p><small class="text-muted">uniquement si différente de l’adresse de livraison</small></p></div>
      </div>
      <div class="row" style="margin-top:5px;">
        <div class="col-sm-4 col-xs-12" style="margin: 0px;"><label>nom et prénom</label></div>
...
function calculTotal()
{
  ...
  {
    prixTotal += bouteilles[ i ].name * bouteilles[ i ].value;
  }
